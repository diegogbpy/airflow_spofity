...
run_etl = PythonOperator(task_id='whole_spotify_etl', python_callable=run_spotify_etl, dag=dag)

run_from_db_to_csv = PythonOperator(task_id='from_db_to_csv', python_callable=run_from_db_to_csv, dag=dag)
